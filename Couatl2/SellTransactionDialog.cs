...
namespace Couatl2
{
	public partial class SellTransactionDialog : Form
	{
		public SellTransactionDialog()
		{
			InitializeComponent();
		}
		...
		private void SymbolTextBox_Leave(object sender, EventArgs e)
		{
			...
			// 3. Validating
			// 4. Validated
			System.Diagnostics.Debug.WriteLine("STD :: Leave symbol text box event.");
		}
