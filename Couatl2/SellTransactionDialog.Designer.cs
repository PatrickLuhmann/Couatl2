namespace Couatl2
{
	partial class SellTransactionDialog
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.ProceedsTextBox = new System.Windows.Forms.TextBox();
			...
			// ProceedsTextBox
			// 
			this.ProceedsTextBox.Location = new System.Drawing.Point(87, 95);
			this.ProceedsTextBox.Name = "ProceedsTextBox";
			this.ProceedsTextBox.Size = new System.Drawing.Size(100, 20);
			this.ProceedsTextBox.TabIndex = 5;
			// 
			// label4
			// 
			...
			this.Controls.Add(this.ProceedsTextBox);
			...
			this.Name = "SellTransactionDialog";
			this.Text = "SellTransactionDialog";
		...
		private System.Windows.Forms.TextBox ProceedsTextBox;
